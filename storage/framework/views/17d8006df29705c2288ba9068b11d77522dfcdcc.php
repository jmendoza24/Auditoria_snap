...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="<?php echo e(url('app-assets/css/pages/login-register.css')); ?>">
  <!-- END Page Level CSS-->
  <!-- BEGIN Custom CSS-->
...
<body class="vertical-layout vertical-menu 1-column   bg-lighten-2 menu-expanded blank-page blank-page" data-open="click" data-menu="vertical-menu" data-col="1-column" style="background: #518a87;">
            ...
            <div class="col-md-4 col-10 box-shadow-2 p-0">
              <div class="card border-grey border-lighten-3 m-0">
                <div class="card-header border-0">
                  <div class="card-title text-center">
                    <div class="p-1">
                        ...
                        <!--<h4><b><img class="brand-logo" alt="stack admin logo"  style="width: 50%;" src="<?php echo e(url('app-assets/images/logo/flux.png')); ?>"></b></h4>-->
                ...
                <div class="card-content">
                    ...
                    <form method="post" class="form-horizontal" action="<?php echo e(url('/login')); ?>">
                        <?php echo csrf_field(); ?>
                            ...
                            <fieldset class="form-group floating-label-form-group">
                              ...
                              <input type="text" class="form-control" required="" id="email" name="email" placeholder="Tu email" value="<?php echo e(old('email')); ?>">
                            </fieldset>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-6 col-12 float-sm-left text-center text-sm-right"><a href="<?php echo e(url('/password/reset')); ?>" class="card-link">Olvidaste tu contraseña?</a></div>
                      </div>
                  ...
                  <div class="card-body">
                    <a href="<?php echo e(url('/register')); ?>" class="btn btn-outline-danger btn-block"><i class="ft-user"></i> Registro</a>
                  </div>
                </div>
              </div>
            </div>
  ...
  <!-- END STACK JS-->
  <!-- BEGIN PAGE LEVEL JS-->
  <!--<script src="<?php echo e(url('app-assets/js/scripts/forms/form-login-register.js')); ?>" type="text/javascript"></script>-->
  <!-- END PAGE LEVEL JS-->
  <script>
    $(function () {
        $('input').iCheck({
...
<?php /**PATH C:\wamp64\www\laravel\Auditoria_snap\resources\views/auth/login.blade.php ENDPATH**/ ?>