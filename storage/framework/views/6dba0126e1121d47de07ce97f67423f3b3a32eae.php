            ...
            <div class="col-md-4 col-10 box-shadow-2 p-0">
              <div class="card border-grey border-lighten-3 px-1 py-1 m-0">
                ...
                <div class="card-content">
                  <div class="card-body pt-0">
                    <form class="form-horizontal" method="post" action="<?php echo e(url('/register')); ?>">
                      ...
                      <fieldset class="form-group floating-label-form-group">
                        ...
                        <input type="text" class="form-control" id="name"  name="name" value="<?php echo e(old('name')); ?>" required="" placeholder="Tu nombre">
                      </fieldset>
                      <fieldset class="form-group floating-label-form-group">
                        <label for="user-email">Correo Electronico</label>
                        <input type="email" class="form-control" id="email" name="email" value="<?php echo e(old('email')); ?>" required="" placeholder="Tu Email">
                      </fieldset>
                  ...
                  <div class="card-body pt-0">
                    <a href="<?php echo e(url('/login')); ?>" class="btn btn-outline-danger btn-block"><i class="ft-unlock"></i> Login</a>
                  </div>
                </div>
              </div>
            </div>
...
<?php /**PATH /var/www/html/auditoria/resources/views/auth/register.blade.php ENDPATH**/ ?>