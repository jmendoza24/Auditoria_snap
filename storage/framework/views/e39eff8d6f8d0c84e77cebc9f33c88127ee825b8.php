...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="<?php echo e(url('app-assets/vendors/css/tables/extensions/responsive.dataTables.min.css')); ?>">
  <link rel="stylesheet" type="text/css" href="<?php echo e(url('app-assets/vendors/css/tables/datatable/select.dataTables.min.css')); ?>">
  <link rel="stylesheet" type="text/css" href="<?php echo e(url('app-assets/vendors/css/tables/extensions/buttons.dataTables.min.css')); ?>">
  <link rel="stylesheet" type="text/css" href="<?php echo e(url('app-assets/vendors/css/tables/datatable/buttons.bootstrap4.min.css')); ?>">
  <link rel="stylesheet" type="text/css" href="<?php echo e(url('app-assets/vendors/css/tables/extensions/dataTables.colVis.css')); ?>">
  ...
  <link rel="stylesheet" type="text/css" href="<?php echo e(url('app-assets/vendors/js/gallery/photo-swipe/photoswipe.css')); ?>">
  <link rel="stylesheet" type="text/css" href="<?php echo e(url('app-assets/vendors/js/gallery/photo-swipe/default-skin/default-skin.css')); ?>">
  <link rel="stylesheet" type="text/css" href="<?php echo e(url('app-assets/css/pages/gallery.css')); ?>">
...
<?php endif; ?>
 ...
 <script src="<?php echo e(url('app-assets/vendors/js/vendors.min.js')); ?>" type="text/javascript"></script>
  ...
  <script src="<?php echo e(url('app-assets/vendors/js/tables/datatable/buttons.bootstrap4.min.js')); ?>" type="text/javascript"></script>
  ...
  <script src="<?php echo e(url('app-assets/vendors/js/tables/datatable/dataTables.colVis.js')); ?>" type="text/javascript"></script>
  <script src="<?php echo e(url('app-assets/js/scripts/tables/datatables-extensions/datatable-colvis.js')); ?>" type="text/javascript"></script>

  <script src="<?php echo e(url('app-assets/js/scripts/modal/components-modal.js')); ?>" type="text/javascript"></script>
  <script src="https://code.jquery.com/ui/1.12.1/jquery-ui.js"></script>

  <script src="<?php echo e(url('app-assets/vendors/js/gallery/masonry/masonry.pkgd.min.js')); ?>" type="text/javascript"></script>
  ...
  <script type="text/javascript" src="<?php echo e(url('app-assets/js/scripts/scripts.js')); ?>"></script>
  <script type="text/javascript" src="<?php echo e(url('app-assets/vendors/js/ui/jquery.sticky.js')); ?>"></script>
...
</div><?php /**PATH C:\wamp64\www\laravel\Auditoria_snap\resources\views/layouts/app.blade.php ENDPATH**/ ?>